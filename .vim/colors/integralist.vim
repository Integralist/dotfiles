" Integralist
" Inspired entirely by Tomorrow Night 
" With some minor tweaks for: Go, Ruby and Python
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("Define", s:comment, "", "none")
	...
	call <SID>X("rubyControl", s:orange, "", "")
	...
	" Go Highlighting
	call <SID>X("goDirective", s:blue, "", "")
	call <SID>X("goDeclaration", s:red, "", "")
	call <SID>X("goStatement", s:yellow, "", "")
	call <SID>X("goConditional", s:yellow, "", "")
	call <SID>X("goConstants", s:orange, "", "")
	call <SID>X("goTodo", s:yellow, "", "")
	call <SID>X("goDeclType", s:yellow, "", "")
	call <SID>X("goBuiltins", s:yellow, "", "")
	call <SID>X("goRepeat", s:yellow, "", "")
